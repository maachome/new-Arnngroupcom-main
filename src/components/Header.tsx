    ...
    return (
        <header className={`fixed left-0 right-0 z-50 py-6 px-8 flex-shrink-0 transition-all duration-500 ${isVisible ? 'top-0' : '-top-32'
            ...
            <div className="w-full relative">
                ...
                <Link to="/" className="absolute flex items-center gap-3 hover:opacity-80 transition-opacity left-0 ml-16 md:ml-24 lg:ml-32 xl:ml-48 top-8 md:top-12 lg:top-16 xl:top-20 2xl:top-24">
                    <img
                        src={logo}
                        alt="ARNN Group"
                        className="
                ...
                <div className="flex justify-end items-center">
                    ...
                    <nav className="hidden lg:flex items-center gap-8 mt-8">
                        ...
                        >
                            <button
                                className={`flex items-center gap-1 text-sm tracking-wide hover:opacity-80 transition-opacity ${isServicePage ? `border-b-2 ${isScrolled || location.pathname !== '/' ? 'border-white' : 'border-gray-900'}` : ''
                                    }`}
                            >
                                OUR BUSINESSES
                    ...
                    <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                        ...
                        <SheetContent side="right" className="w-full bg-[#2d3e5f] text-white border-l border-white/10">
                            <SheetHeader>
                            ...
                            <nav className="flex flex-col gap-1 mt-8">
                                ...
                                <Link
                                    to="/about-us"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                    className={`px-4 py-3 text-sm tracking-wide hover:bg-white/10 transition-colors rounded-lg ${location.pathname === '/about-us' ? 'bg-white/10' : ''
                                        }`}
                                >
                                    ABOUT US
                                </Link>
                                ...
                                <Link
                                    to="/contact"
                                    onClick={() => setIsMobileMenuOpen(false)}
                                    className={`px-4 py-3 text-sm tracking-wide hover:bg-white/10 transition-colors rounded-lg ${location.pathname === '/contact' ? 'bg-white/10' : ''
                                        }`}
                                >
                                    CONTACT
                                </Link>
